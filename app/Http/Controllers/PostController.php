...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Publicación agregada');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Publicación actualizada');
        }
        else{
            request()->session()->flash('error','¡¡Inténtalo de nuevo!!');
        }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Publicación eliminada');
        }
        else{
