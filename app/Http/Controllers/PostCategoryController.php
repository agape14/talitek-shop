...
class PostCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Categoría de publicación agregada');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Categoría de publicación actualizada');
        }
        else{
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Categoría de publicación eliminada');
        }
        else{
            request()->session()->flash('error','Error al eliminar la categoría de publicación');
        }
        return redirect()->route('post-category.index');
    }
}
