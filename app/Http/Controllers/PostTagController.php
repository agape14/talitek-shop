...
class PostTagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Etiqueta de publicación agregada');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Etiqueta de publicación actualizada');
        }
        else{
            request()->session()->flash('error','¡¡Inténtalo de nuevo!!');
        }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Etiqueta de publicación eliminada');
        }
        else{
