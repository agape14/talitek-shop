...
@section('main-content')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Carrito</a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								@else
										<tr>
											<td class="text-center">
												No hay items disponible en el carrito. <a href="{{route('product-grids')}}" style="color:blue;">Seguir comprando</a>
					...
					<div class="total-amount">
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											@csrf
											<input name="code" placeholder="Ingrese el cupón válido">
											<button class="btn">Aplicar Cupon</button>
										</form>
									</div>
									{{-- <div class="checkbox">`
										@php
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Sub total Carrito<span>S/. {{number_format(Helper::totalCartPrice(),2)}}</span></li>

										@if(session()->has('coupon'))
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Aplicar<span>S/. {{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Monto Pagar<span>S/. {{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Monto Pagar<span>S/. {{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
	...
	{{--<section class="shop-newsletter section" style="background: #f6f6f6;">
