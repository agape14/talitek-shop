...
@section('title', config('app.name', 'Talitek') . ' || Registrar Pagina')
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        ...
                                        <a href="{{route('login.form')}}" class="btn btn-google">Regresar a iniciar sesión</a>
                                        <!-- OR
...
<style>
    ...
    .btn-google:hover{
        background:rgb(221,3,90) !important;
    }
</style>
@endpush