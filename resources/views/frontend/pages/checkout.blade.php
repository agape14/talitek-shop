                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                <h2>Completa su compra</h2>
                                <p>Sólo unos pocos pasos más para completar tu compra de forma segura.</p>
                                <!-- Form -->
                                <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <label class="btn btn-github">
                                                    <input type="radio" name="payment_method"  value="cod" required> Contra entrega
                                    
                                                </label><br>
                                                <!-- <input name="payment_method"  type="radio" value="cod" required> <label> Contra entrega</label></input><br>
                                                <input name="payment_method"  type="radio" value="paypal"> <label> PayPal</label><br> 
                                                <input name="payment_method"  type="radio" value="cardpay" required> <label> Pago con tarjeta</label>-->
                                                <br>
                                                <!-- Credit Card Details -->
                                ...
                                <div class="single-widget payement">
                                    <div class="content">
                                        <img src="{{('backend/img/payment_contraentrega.png')}}" alt="#">
                                    </div>
                                </div>
                                ...
                                <div class="single-widget get-button">
                                    <div class="content">
                                        <div class="button">
                                            <button type="submit" class="btn">Procesar el pago</button>
                                        </div>
                                    </div>
                                </div>
                                <!--/ End Button Widget -->
