...
@section('title', config('app.name', 'Talitek') . ' || Lista de tiendas')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Lista de tiendas</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Agregado reciente</h3>
                                    {{-- {{dd($recent_products)}} --}}
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
												...
												{{ $tipos_monedas[2]->valor ?? '' }}{{number_format($product->price_dollar, 2)}}
                                                {{ $tipos_monedas[1]->valor ?? '' }}{{number_format($product->price, 2)}}                                            
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Añadir a la lista de deseos" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Añadir a la lista de deseos</span></a>
																</div>
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														<div class="product-content">
															...
															<h6 class="text-primary"><small>{{ $tipos_monedas[2]->valor ?? '' }}{{number_format($product->price_dollar, 2)}}</small>    {{ $tipos_monedas[1]->valor ?? '' }}{{number_format($product->price, 2)}}  </h6>
															
														</div>
														<p class="des pt-2">{!! html_entity_decode($product->summary) !!}</p>
														<a href="{{route('add-to-cart',$product->slug)}}" class="btn cart"><i class="ti-heart"></i>  Agregar al carrito</a>
									...
									@endforeach
								@else
									<h4 class="text-danger" style="margin:100px auto;">Lo sentimos, no hay productos según la gama indicada. Intente seleccionar uno diferente para ver más resultados.</h4>
								@endif
							</div>
							 <div class="row">
									...
									<div class="row no-gutters">
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
												...
												@endphp
												<h3 class="text-primary"><small>{{ $tipos_monedas[2]->valor ?? '' }}{{number_format($product->price_dollar, 2)}}</small>    {{ $tipos_monedas[1]->valor ?? '' }}{{number_format($product->price, 2)}}  </h3>
												...
												<br>
												<a href="https://wa.me/51{{$settingprimero->phone}}?text=Estoy%20interesado%20en%20un%20producto: {{$product->title}}" target="_blank" rel="noopener noreferrer" class="btn-success p-2">
